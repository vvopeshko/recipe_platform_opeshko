...
// During build time, create a dummy client if env vars are missing to prevent build failures
// The actual client will be used at runtime when env vars are available
